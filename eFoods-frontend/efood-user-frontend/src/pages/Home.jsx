...
import isharaP from '../assets/ishara.png';
import nearandaP from '../assets/neranda.png';
import buwanekaP from '../assets/buwaneka.png';
    ...
    <div className="font-sans text-gray-800 overflow-x-hidden">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto animate-on-scroll opacity-0">
            <Testimonial 
              image={nearandaP}
              text="Absolutely amazing food and super-fast delivery! The tracking feature is fantastic." 
              name="Nearanda Dilhara" 
            />
            <Testimonial 
              image={isharaP}
