          ...
          <div className="flex overflow-x-auto pb-2 mb-4 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
            {categories.map(category => (
              <button
                ...
                className={`px-4 py-2 whitespace-nowrap mr-2 rounded-full text-sm font-medium transition-all ${
                ...
                >
                  ...
                  <div className="p-4">
                    <div className="flex justify-between items-start">
                      ...
                      <span
                        className={`inline-flex h-6 items-center px-2 py-0.5 text-xs font-medium rounded-full ${
                          item.isAvailable 
